...
import { UpdateRegisterBonusDialog } from './UpdateRegisterBonusDialog';
...
function Actions(props: { target: RegisterBonusListData }) {
  ...
  const handleDetailsClick = () => {
    router.push(
      `/register-bonus/details?name=${target?.bonusTitle}&id=${target.id}`
    );
  };
  return (
...
export const columnDefs: ColumnDef<RegisterBonusListData>[] = [
  {
