...
import { RejectTransactionDialog } from '../../../transactions/components/RejectTransactionDialog';
...
const PendingDetails = () => {
  ...
  const [acceptAction, { isLoading: isAccepting }] =
    useApproveTransactionsWithdrawMutation();
  const [rejectAction, { isLoading: isRejecting }] =
    useRejectTransactionsWithdrawMutation();
