...
import { CreateWithdrawAdminFormDialog } from './components/CreateWithdrawAdminFormDialog';
import { useGetWithdrawAdminQuery } from '../../../..//stores/reducers/withdraw-admin.reducer';
...
const WithdrawAdmin = () => {
  ...
  const { data } = useGetWithdrawAdminQuery(query);
