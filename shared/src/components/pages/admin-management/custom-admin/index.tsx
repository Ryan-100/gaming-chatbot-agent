...
import { CreateCustomAdminFormDialog } from './components/CreateCustomAdminFormDialog';
...
import { useGetCustomAdminQuery } from '../../../../stores/reducers/custom-admin.reducer';
...
const CustomAdmin = () => {
  ...
  const { data, isLoading } = useGetCustomAdminQuery(query);
