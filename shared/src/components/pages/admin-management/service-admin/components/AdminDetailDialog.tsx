...
import { useGetServiceAdminDetailQuery } from '../../../../../stores/reducers/service-admin.reducer';
...
export const AdminDetailsDialog: React.FC<AdminDetailsDialogProps> = ({
  ...
  const { data: detailData } = useGetServiceAdminDetailQuery({ id });
  ...
  return (
    <Dialog open={open}>
      <DialogContent className="py-0">
        ...
        >
          <DialogTitle>Service Admin Details</DialogTitle>
