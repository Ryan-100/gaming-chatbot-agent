...
import { ServiceAdminListData } from '../../../../../types/service-admin.types';
import { UpdateServiceAdminFormDialog } from './UpdateServiceAdminFormDialog';
import { ChangeAdminStatusDialog } from './ChangeAdminStatusDialog';
import { AdminDetailsDialog } from './AdminDetailDialog';

function Name(props: { target: ServiceAdminListData }) {
  const { target } = props;
  return (
...
function Status(props: { target: ServiceAdminListData }) {
  const { target } = props;
...
function Actions(props: { target: ServiceAdminListData }) {
  const { target } = props;
...
export const columnDefs: ColumnDef<ServiceAdminListData>[] = [
  {
    accessorKey: 'name',
    header: 'Name',
    cell({ row }) {
