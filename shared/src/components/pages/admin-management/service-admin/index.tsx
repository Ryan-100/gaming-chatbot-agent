...
import { CreateServiceAdminFormDialog } from './components/CreateServiceAdminFormDialog';
...
import { useGetServiceAdminQuery } from '../../../../stores/reducers/service-admin.reducer';
...
const ServiceAdmin = () => {
  ...
  const { data, isLoading } = useGetServiceAdminQuery(query);
