...
import { useGetTransactionDepositBonusQuery } from '../../../../stores/reducers/transaction-deposit-bonus.reducer';
...
const DepositBonus = () => {
  ...
  const { data, isLoading } = useGetTransactionDepositBonusQuery(query);
