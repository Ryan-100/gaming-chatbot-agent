...
import { useGetTransactionsDepositQuery } from '../../../../stores/reducers/transactions-deposit.reducer';
...
const Deposit = () => {
  ...
  const { data, isLoading } = useGetTransactionsDepositQuery(query);
          ...
          <Select onValueChange={(value) => handleStatus(value)}>
            ...
            <SelectContent className="min-w-[120px] max-w-[120px]">
              <SelectGroup className="min-w-[120px] max-w-[120px]">
                ...
                <SelectItem value="PREACCEPTED">Preaccepted</SelectItem>
              </SelectGroup>
            </SelectContent>
          </Select>
        </Flex>
