...
import { useGetReportDepositAdminDetailQuery } from '../../../../../stores/reducers/report-deposit-admin.reducer';
...
const DepositAdminDetails = () => {
  ...
  const { data, isLoading } = useGetReportDepositAdminDetailQuery(query);
    ...
    <Box className="space-y-4">
      ...
      >
        ...
        <Flex className="flex-1">
          <Input
            placeholder="Search by TXN no or mount"
...
export default DepositAdminDetails;
